# Task — Current Priorities

## CURRENT PRIORITY:

- [x] Завершить спецификацию: return, обработка ошибок, списки и объекты
- [x] Написать `tokenizer.js`
- [x] Написать `parser.js`
- [x] Написать `interpreter.js`
...
- [x] ui12 v0.2 — компоненты (input, card, alert)
- [x] Правило №15 — элементы интерфейса
- [x] ui12 v0.3 — анимации (hover, active, fadeIn, zoom)
- [x] Финальная документация v1.0
